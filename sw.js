const CACHE='fiscal-generator-v4';
const ASSETS=['./','./index.html','./styles.css','./mobile.css','./enhancements.css','./fiscal-engine.js','./lab-data.js','./xml-engine.js','./app.js','./document-renderer.js','./lab-ui.js','./enhancements.js','./responsive.js','./manifest.webmanifest'];
